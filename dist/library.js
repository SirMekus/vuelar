          ...
          ($props.links.prev_page_url != null)
            ? (vue.openBlock(), vue.createElementBlock("li", _hoisted_3, [
                vue.createElementVNode("a", {
                  ...
                  rel: "prev",
                  "aria-label": "« Previous",
                  onClick: _cache[0] || (_cache[0] = vue.withModifiers($event => ($setup.paginate($setup.getQueryStringsFromUrl($props.links.prev_page_url))), ["prevent"]))
                }, "‹", 8 /* PROPS */, _hoisted_4)
              ]))
            : (vue.openBlock(), vue.createElementBlock("li", _hoisted_5, _hoisted_7)),
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.links.links, (link) => {
            return (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
              (isNaN(link.label) == false)
                ? (vue.openBlock(), vue.createElementBlock("li", {
                    key: 0,
                    class: vue.normalizeClass(["page-item", { active: link.active == true }])
                  }, [
                    vue.createElementVNode("a", {
                      class: vue.normalizeClass(["page-link", { 'disabled-link': $props.links.current_page == link.label }]),
                      href: link.url,
                      onClick: vue.withModifiers($event => ($setup.paginate($setup.getQueryStringsFromUrl(link.url))), ["prevent"])
                    }, vue.toDisplayString(link.label), 11 /* TEXT, CLASS, PROPS */, _hoisted_8)
                  ], 2 /* CLASS */))
          ...
          ($props.links.next_page_url != null)
            ? (vue.openBlock(), vue.createElementBlock("li", _hoisted_9, [
                vue.createElementVNode("a", {
                  ...
                  onClick: _cache[1] || (_cache[1] = vue.withModifiers($event => ($setup.paginate($setup.getQueryStringsFromUrl($props.links.next_page_url))), ["prevent"])),
                  rel: "next",
                  "aria-label": "Next »"
                }, "›", 8 /* PROPS */, _hoisted_10)
              ]))
            : (vue.openBlock(), vue.createElementBlock("li", _hoisted_11, _hoisted_13))
        ])
      ]))
    : vue.createCommentVNode("v-if", true)
}
